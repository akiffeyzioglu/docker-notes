...
`docker container run --rm -it hello-world sh:` Containerc çalıştırır. "--rm" container çalıştırıldıktan sonra sil demektir. "-it" "--interactive" ve "--tty" birleşimidir. Containera interaktif bağlantı yapar. "sh" ile de uzak makinedeki containera terminal bağlantısı ekler. 